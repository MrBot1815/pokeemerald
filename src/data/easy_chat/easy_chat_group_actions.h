const u8 gEasyChatWord_Die[] = _("DIE");
const u8 gEasyChatWord_Concede[] = _("FUCK YOU");
const u8 gEasyChatWord_Give[] = _("SHITTYMON");
...
const u8 gEasyChatWord_KillYourself[] = _("KILL YOURSELF");
const u8 gEasyChatWord_FuckYou[] = _("FUCK YOU");
const u8 gEasyChatWord_Angers[] = _("ANGERS");
const u8 gEasyChatWord_Shit[] = _("SHIT");
const u8 gEasyChatWord_Shits[] = _("SHITS");
